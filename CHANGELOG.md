...
- Windows installer (.msi) artifact was empty or double-zipped due to broken CI packaging step.
- WiX shortcut component was in a sub-feature causing ICE69 linker warning.
